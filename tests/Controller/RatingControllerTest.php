...
final class RatingControllerTest extends WebTestCase{
    ...
    protected function setUp(): void
    {
        ...
        $this->repository = $this->manager->getRepository(Rating::class);
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'rating[userId]' => 'Testing',
            'rating[statisticsId]' => 'Testing',
        ]);
    ...
    public function testShow(): void
    {
        ...
        $fixture->setStatisticsId('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'rating[userId]' => 'Something New',
            'rating[statisticsId]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getStatisticsId());
    }
